...
{
this.bInProcess = false; this.InProcessElTagName = ""; this.InProcessICActionValue = ""; this.prevReadyState = net2.READY_STATE_UNINITIALIZED; this.form = null;this.url = null; this.sAjaxTrfUrl = (typeof sAjaxTrfUrl == "undefined" || !sAjaxTrfUrl) ? null : sAjaxTrfUrl;this.sScriptAfter = (typeof sScriptAfter == "undefined" || !sScriptAfter) ? null : sScriptAfter;this.bWarning = (typeof bWarning == "undefined" || bWarning) ? true : false;this.nTrfURLType = (typeof nTrfURLType == "undefined") ? -1 : nTrfURLType;this.params = ""; this.bAlert=true; this.WaitingObjQueue = new Array(); this.bScript = false; this.arrScript = new Array(); this.arrSrcScript = new Array(); this.arrSrcScriptApp = new Array(); this.arrSrcCSSApp = ""; this.nScript = -1; this.nSrcScript = -1; this.nScriptfiles = 0; this.nScriptfileIndex = 0; this.oScript = ""; this.msgList;this.OnloadScriptList;this.objGrouplet = null;this.sortid = "";this.gXMLObj = null; this.gCleanData = ""; if (typeof ptConsole2 != 'undefined' && ptConsole2 && ptConsole2.isActive() && bPerf)
{
...
reduceScrollareaHeight:function(id, data)
 ...
 if (obj) {
 var classValue = "", pclassValue = ""; if (attrs.getNamedItem("class"))
 classValue = attrs.getNamedItem("class").value; if (attrs.getNamedItem("pclass"))
 pclassValue = attrs.getNamedItem("pclass").value;  this.processAttributes(attrs, obj);  if (this.formname + "hdrdivPT_WORK_PT_BUTTON_BACK" == id) {
...
finalCall:function()
{
 ...
 var bProcessMsg = (this.msgList && this.msgList.length > 0 && this.bModal != 2 && this.bModal != 5) ? true : false;  if (!bDoModalURL && !bProcessMsg)
 this.closeModal(); }
 ...
 GetDomData(this.form, "TargetContent", "#GetDomInfo"); if (isFModeLayout()) {
