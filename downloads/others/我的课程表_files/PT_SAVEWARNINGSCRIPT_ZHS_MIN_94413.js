...
if ((changed==null) && top.frames)
 ...
 return psConfirmFluid("\u4fdd\u5b58\u8b66\u544a", "\u662f\u5426\u8981\u4fdd\u5b58\u66f4\u6539?" , "YesNo", saveOKEvent, saveCancelEvent, "\u5355\u51fb\u201c\u662f\u201d\u53ef\u8fd4\u56de\u8fdb\u884c\u4fdd\u5b58\uff0c\u5355\u51fb\u201c\u5426\u201d\u5c06\u653e\u5f03\u66f4\u6539", pWin, bDelay);}
var rtn = true;if (changed)
{
 ...
 if (typeof isNewSaveWarn !== "undefined" && isNewSaveWarn) {
  psConfirm2("\u4fdd\u5b58\u8b66\u544a", "\u662f\u5426\u4fdd\u5b58\u66f4\u6539? \u5355\u51fb\u201c\u662f\u201d\u8fd4\u56de\u5e76\u4fdd\u5b58\uff0c\u6216\u5355\u51fb\u201c\u5426\u201d\u653e\u5f03\u66f4\u6539\u3002", "YesNo", saveOKEvent, saveCancelEvent, null, bDelay); } else {
  psConfirm2("\u4fdd\u5b58\u8b66\u544a", "\u6b64\u9875\u9762\u4e2d\u6709\u5c1a\u672a\u4fdd\u5b58\u7684\u6570\u636e\u3002\u5355\u51fb\u201c\u786e\u5b9a\u201d\u8fd4\u56de\u5e76\u4fdd\u5b58\uff0c\u5355\u51fb\u201c\u53d6\u6d88\u201d\u7ee7\u7eed\u3002", "OKCancel", saveCancelEvent, saveOKEvent, null, bDelay); }
 }
 else {
 ...
 return; } else
 rtn = !confirm("\u6b64\u9875\u9762\u4e2d\u6709\u5c1a\u672a\u4fdd\u5b58\u7684\u6570\u636e\u3002\u5355\u51fb\u201c\u786e\u5b9a\u201d\u8fd4\u56de\u5e76\u4fdd\u5b58\uff0c\u5355\u51fb\u201c\u53d6\u6d88\u201d\u7ee7\u7eed\u3002");}
...
if (isFModeLayout() && isSUOW) {
 var agTarget = typeof document.getElementById("ICAGTarget") != 'undefined' && document.getElementById("ICAGTarget"); var agChanged = agTarget ? (typeof document.getElementById("ICUOW") != 'undefined' && document.getElementById("ICUOW") != null && document.getElementById("ICUOW").value != "N" ? true : false) : false; if (agChanged)
 return psConfirmFluid("\u4fdd\u5b58\u8b66\u544a", "\u662f\u5426\u8981\u4fdd\u5b58\u66f4\u6539?" , "YesNo", saveOKEvent, saveCancelEvent, "\u6d3b\u52a8\u6307\u5bfc\u4e2d\u7684\u6240\u6709\u66f4\u6539\u90fd\u5c06\u4e22\u5931\u3002\u5355\u51fb\u201c\u662f\u201d\u53ef\u8fd4\u56de\u5e76\u4fdd\u5b58\uff0c\u5355\u51fb\u201c\u5426\u201d\u5c06\u653e\u5f03\u66f4\u6539", pWin);}
 if (!isFModeLayout()) {
 if (typeof isNewSaveWarn !== "undefined" && isNewSaveWarn) {
 return psConfirm2("\u4fdd\u5b58\u8b66\u544a", "\u662f\u5426\u4fdd\u5b58\u66f4\u6539? \u5355\u51fb\u201c\u662f\u201d\u8fd4\u56de\u5e76\u4fdd\u5b58\uff0c\u6216\u5355\u51fb\u201c\u5426\u201d\u653e\u5f03\u66f4\u6539\u3002", "YesNo", saveOKEvent, saveCancelEvent, pWin); } else {
 return psConfirm2("\u4fdd\u5b58\u8b66\u544a", "\u6b64\u9875\u9762\u4e2d\u6709\u5c1a\u672a\u4fdd\u5b58\u7684\u6570\u636e\u3002\u5355\u51fb\u201c\u786e\u5b9a\u201d\u8fd4\u56de\u5e76\u4fdd\u5b58\uff0c\u5355\u51fb\u201c\u53d6\u6d88\u201d\u7ee7\u7eed\u3002", "OKCancel", saveCancelEvent, saveOKEvent, pWin); }
 }
 else {
 return psConfirmFluid("\u4fdd\u5b58\u8b66\u544a", "\u662f\u5426\u8981\u4fdd\u5b58\u66f4\u6539?" , "YesNo", saveOKEvent, saveCancelEvent, "\u5355\u51fb\u201c\u662f\u201d\u53ef\u8fd4\u56de\u8fdb\u884c\u4fdd\u5b58\uff0c\u5355\u51fb\u201c\u5426\u201d\u5c06\u653e\u5f03\u66f4\u6539", pWin); }
}
...
function psConfirm2(msgTitle, msg, msgType, event1, event2, pWin, bDelay) {
 ...
 sCancel = "\u53d6\u6d88",
 sYes = "\u662f",
 sNo = "\u5426"; shtml = "<div id='msgTitle' style='display:none;'>" + msgTitle + "</div>"; shtml += "<div id='alertmsg'><span class='popupText'>" + msg + "</span></div>"; if (msgType == "OKCancel") {
 ...
 shtml += "<div id='alertbutton'><a class='PSPUSHBUTTON Left' style='border:0;'><span><input type='button' id='#ALERTYES' name='#ALERTOK' class='PSPUSHBUTTONTBOK' value='"; shtml += (sYes + "' tabindex='0' alt='" + sYes + "' title='" + sYes + "' onclick='" + event1 + ";closeMsg(this);' /></span></a>"); shtml += ("<a class='PSPUSHBUTTON Left' style='border:0;'><span><input type='button' id='#ALERTNO' name='#ALERTNO' class='PSPUSHBUTTONTBOK' value='"); shtml += (sNo + "' tabindex='0' alt='" + sNo + "' title='" + sNo + "' onclick='" + event2 + ";closeMsg(this);' /></span></a>"); } else if (msgType == "YesNoCancel") {
 shtml += "<div id='alertbutton'><a class='PSPUSHBUTTON Left' style = 'border:0;'><span><input type=button id='#ALERTYES' name='#ALERTOK' class='PSPUSHBUTTONTBOK' value='"; shtml += (sYes + "' tabindex='0' alt='" + sOK + "' title='" + sYes + "' onclick='" + event1 + ";closeMsg(this);' /></span></a>"); shtml += ("<a class='PSPUSHBUTTON Left' style = 'border:0;'><span><input type=button id='#ALERTNO' name='#ALERTNO' class='PSPUSHBUTTONTBOK' value='"); shtml += (sNo + "' tabindex='0' alt='" + sCancel + "' title='" + sNo + "' onclick='" + event2 + ";closeMsg(this);' /></span></a>"); shtml += ("<a class='PSPUSHBUTTON Left' style = 'border:0;'><span><input type=button id='#ALERTCANCEL' name='#ALERTCANCEL' class='PSPUSHBUTTONTBOK' value='"); shtml += (sCancel + "' tabindex='0' alt='" + sCancel + "' title='" + sCancel + "' onclick='closeMsg(this);' /></span></a></div>"); } else {
 shtml += "<div id='alertbutton'><a class='PSPUSHBUTTON Left' style = 'border:0;'><span><input type=button id='#ALERTOK' name='#ALERTOK' class='PSPUSHBUTTONTBOK' value='"; shtml += (sOK + "' tabindex='0' alt='" + sOK + "' title='" + sOK + "' onclick='closeMsg(this);' /></span></a></div>"); }
 ...
 eval(event2); }
 if (msgType == "YesNo") {
 var rtn = !confirm("\u6b64\u9875\u9762\u4e2d\u6709\u5c1a\u672a\u4fdd\u5b58\u7684\u6570\u636e\u3002\u5355\u51fb\u201c\u786e\u5b9a\u201d\u8fd4\u56de\u5e76\u4fdd\u5b58\uff0c\u5355\u51fb\u201c\u53d6\u6d88\u201d\u7ee7\u7eed\u3002"); if (rtn)
 eval(event2); else
 eval(event1); }
 }
}
