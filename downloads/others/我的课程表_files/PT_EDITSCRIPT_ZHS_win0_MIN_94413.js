...
msg = PSmessageSubst_win0(msg, PSerror_win0.arguments, 2);if (isFModeLayout()) 
 psConfirmFluid("\u9519\u8bef", msg);else
 psAlert(msg, "\u9519\u8bef");oErr_win0=obj;}
...
{
var s = prompt("\u8f93\u5165\u641c\u7d22\u5b57\u7b26\u4e32:","");if (s == null || s == "")
...
var deleteAction = 'oParentWin.aAction_win0(oParentWin.document.win0' + ',"' + name + '")';psConfirm2("\u5220\u9664\u786e\u8ba4", "\u662f\u5426\u4ece\u8be5\u9875\u9762\u5220\u9664\u5f53\u524d\u884c/\u6240\u9009\u884c? \u4fdd\u5b58\u4e8b\u52a1\u5904\u7406\u65f6\u5c06\u8fdb\u884c\u5220\u9664\u64cd\u4f5c\u3002", "OKCancel", " ", deleteAction);}

function DeleteCheck2_win0()
{
if (arguments.length == 0) 
 return confirm("\u662f\u5426\u4ece\u8be5\u9875\u9762\u5220\u9664\u5f53\u524d\u884c/\u6240\u9009\u884c? \u4fdd\u5b58\u4e8b\u52a1\u5904\u7406\u65f6\u5c06\u8fdb\u884c\u5220\u9664\u64cd\u4f5c\u3002");else 
 {
 ...
 psConfirmFluid("\u5220\u9664\u786e\u8ba4", "\u662f\u5426\u4ece\u6b64\u9875\u9762\u4e2d\u5220\u9664\u5f53\u524d/\u9009\u5b9a\u884c?", "OKCancel", " ", deleteAction, "\u5220\u9664\u5c06\u5728\u4fdd\u5b58\u4e8b\u52a1\u5904\u7406\u65f6\u6267\u884c\u3002"); else 
 psConfirm2("\u5220\u9664\u786e\u8ba4", "\u662f\u5426\u4ece\u8be5\u9875\u9762\u5220\u9664\u5f53\u524d\u884c/\u6240\u9009\u884c? \u4fdd\u5b58\u4e8b\u52a1\u5904\u7406\u65f6\u5c06\u8fdb\u884c\u5220\u9664\u64cd\u4f5c\u3002", "OKCancel", " ", deleteAction); }
}

function AddMultiple_win0(obj)
{
var msg = "\u8f93\u5165\u8981\u6dfb\u52a0\u884c\u7684\u6570\u91cf:";var defreply = "1";while(true)
{
 ...
 msg = "\u8f93\u5165\u503c\u65e0\u6548\u3002\u8bf7\u8f93\u5165 1 \u5230 100 \u4e4b\u95f4\u7684\u6570\u3002" 
 + "\n" + "\u8f93\u5165\u8981\u6dfb\u52a0\u884c\u7684\u6570\u91cf:"; defreply = RegExp.$1;}
}
 ...
 val = obj.value;if (val.search(/^ *$/) == 0 || (bnumeric && val.search(/^[ 0]*$/) == 0))
{
 ...
 PSdeferError(obj, "\u5b57\u6bb5\u4e2d\u9700\u8981\u8f93\u5165\u5185\u5bb9\u3002"); }
}

function addchg_win0(obj,id) {

if (typeof obj == "undefined" && typeof id == "undefined") return;if (obj) id = obj.id; else obj = document.getElementById(id);if (!obj || id.length == 0) return;if (isLoaderInProcess() && obj.type != "checkbox") {
 return;}
...
{
if (!isChanged(obj))
 return false;PSdeferError_win0(obj, "\u53ea\u6709\u5728\u201c\u66f4\u6b63\u201d\u6a21\u5f0f\u4e0b\uff0c\u624d\u80fd\u66f4\u6539\u5f53\u524d\u8bb0\u5f55\u6216\u5386\u53f2\u8bb0\u5f55\u3002");bReset_win0 = true;return true;}

function subscrollUpdated_win0(obj)
{
if (!isChanged(obj))
 return false;PSdeferError_win0(obj, "\u53ea\u6709\u5728\u201c\u66f4\u6b63\u201d\u6a21\u5f0f\u4e0b\u624d\u80fd\u66f4\u6539\u5e26\u6709\u6709\u6548\u65e5\u671f\u7684\u4e0b\u4e00\u7ea7\u6570\u636e\u7684\u5173\u952e\u5b57\u5b57\u6bb5\u3002");bReset_win0 = true;return true;}
...
if(obj.type == "select-one") obj = obj.options[obj.selectedIndex];var dateval = new Date(obj.value);var now = new Date();var diff = new Date(Math.abs(now.getTime() - dateval.getTime()));if (diff.getMonth > 0)
 ...
 PSdeferWarning_win0("\u8b66\u544a - \u65e5\u671f\u8d85\u51fa\u4e86\u8303\u56f4\u3002");return false;}
 ...
 val = obj.value;if (val != 'Y' && val != 'N')
{
 ...
 PSdeferError_win0(obj, "\u8f93\u5165\u503c\u65f6\u5fc5\u987b\u662f Y (\u8868\u793a\u201c\u662f\u201d) \u6216\u662f N (\u8868\u793a\u201c\u5426\u201d)\u3002"); return true;}
return false;}
...
var val = obj.value;if (val == '') return false;if (val.search(/^ *\d* *$/) != 0)
{
 ...
 PSdeferError_win0(obj, "\u201c\u6570\u503c\u201d\u5b57\u6bb5\u683c\u5f0f\u9519\u8bef\u3002\u8bf7\u91cd\u65b0\u8f93\u5165\u3002"); return true;}
return false;}
...
var val = obj.value;if (val == '') return false;if (val.search(re) != 0)
{
 ...
 PSdeferError_win0(obj, "\u201c\u6570\u5b57\u201d\u5b57\u6bb5\u683c\u5f0f\u9519\u8bef\u3002\u8bf7\u4f7f\u7528\u6b63\u786e\u7684\u683c\u5f0f %1 \u91cd\u65b0\u8f93\u5165\u3002", fmt); return true;}
return false;}
...
var val = obj.value;if (val == '') return false;if (!checkTime(val,fmt))
{
 ...
 PSdeferError_win0(obj, "\u201c\u65f6\u95f4\u201d\u5b57\u6bb5\u683c\u5f0f\u9519\u8bef\u3002\u8bf7\u6309\u7167\u6b63\u786e\u683c\u5f0f\u91cd\u65b0\u8f93\u5165\u3002"); return true;}
return false;}
...
var val = obj.value;if (val == '') return false;var newval = checkDateTime(val,fmt);if (newval == "")
{
 ...
 PSdeferError_win0(obj, "\u201c\u65e5\u671f\u65f6\u95f4\u201d\u5b57\u6bb5\u683c\u5f0f\u9519\u8bef\u3002\u8bf7\u6309\u7167\u6b63\u786e\u683c\u5f0f\u91cd\u65b0\u8f93\u5165\u3002"); return true;}
...
{
 PSdeferError_win0(obj, "\u7cfb\u7edf\u65e0\u6cd5\u8bc6\u522b\u60a8\u8f93\u5165\u7684\u65e5\u671f\u3002\u793a\u4f8b\u65e5\u671f: %1");  return true;}
...
var todaystr = "\u4eca\u5929".toUpperCase();if (val.length > 0 && todaystr.indexOf(val.toUpperCase()) == 0) 
...
var bIE = (navigator.userAgent.toLowerCase().indexOf('msie') || navigator.userAgent.toLowerCase().indexOf('trident'));if (typeof selectElemOptions_win0 != "undefined")
 ...
 continue;   var invalidValueText = "\u5217\u987a\u5e8f\u7f16\u53f7\u65e0\u6548"; for (var l = curLen - 1; l >= 0; l--) 
 {
